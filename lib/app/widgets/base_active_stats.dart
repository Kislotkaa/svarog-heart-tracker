                              ...
                              child: ScaleTransition(
                                ...
                                child: StreamBuilder(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    } else if (widget.device!.realHeart.value <
                                        145) {
                            ...
                            child: Row(
                              ...
                              children: [
                                StreamBuilder(
                                  ...
                                  builder: (context, snapshot) {
                                    if (widget.device!.heartDifference.value <
                                        -2) {
                                ...
                                StreamBuilder(
                                  ...
                                  builder: (context, snapshot) {
                                    return AutoSizeText.rich(
                                      TextSpan(
                                        text: widget.device!.realHeart.value
                                            .toString(),
                          ...
                          children: [
                            AutoSizeText.rich(
                              TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                    text: widget.device!.maxHeart.value
                                        .toString(),
                                    style:
                            ...
                            AutoSizeText.rich(
                              TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                    text: widget.device!.minHeart.value
                                        .toString(),
                                    style:
                                        Theme.of(context).textTheme.headline5,
                                  ),
                            ...
                            AutoSizeText.rich(
                              TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                    text: widget.device!.avgHeart.value
                                        .toString(),
                                    style:
                                        Theme.of(context).textTheme.headline5,
                                  ),
