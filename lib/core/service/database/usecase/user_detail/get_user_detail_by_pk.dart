...
class GetUserDetailByPkUseCase extends UseCase<UserDetailModel?, String> {
  final UserDetailRepository userDetailRepository;

  GetUserDetailByPkUseCase(this.userDetailRepository);

  @override
  Future<Either<Failure, UserDetailModel?>> call(String params) async {
    final response = await userDetailRepository.getUserDetailByPk(params);
    return response;
  }
}
