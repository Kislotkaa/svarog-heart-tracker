...
class InsertHistoryUseCase extends UseCase<void, UserHistoryModel> {
  final UserHistoryRepository userHistoryRepository;

  InsertHistoryUseCase(this.userHistoryRepository);

  @override
  Future<Either<Failure, void>> call(UserHistoryModel params) async {
    final model = await userHistoryRepository.insertHistory(params);
    return model;
  }
}
